...
export default function AIAssistantPage() {
    const [messages, setMessages] = useState([
        { role: 'assistant', content: 'Hello! I am your Blue Peak AI Assistant. I can help you summarize text, generate ideas, or answer questions. How can I help you today?' }
    ])
